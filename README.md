...
이 프로젝트는 [Cursor](https://cursor.sh/) AI의 도움을 받아 개발되었습니다. 특히 디자인 결정 과정에서 Cursor의 **Multi Agent Orchestra** 기능을 활용하여 여러 AI 에이전트 간의 토론을 통해 최적의 디자인을 도출했습니다.

#### 디자인 토론 과정

디자인 초기 단계에서 다음과 같은 토론이 이루어졌습니다:

```
[Design Agent 1] "글래스모피즘 스타일이 모바일 청첩장에 적합할 것 같습니다. 
                  반투명 효과로 세련된 느낌을 줄 수 있습니다."

[Design Agent 2] "동의합니다. 다만 배경색과의 대비를 고려해야 합니다. 
                  너무 투명하면 가독성이 떨어질 수 있어요."

[UX Agent] "사용자 경험 측면에서 스크롤 애니메이션을 추가하면 
            더 몰입감 있는 경험을 제공할 수 있습니다."

[Performance Agent] "애니메이션은 성능에 영향을 줄 수 있으니 
                      Framer Motion의 최적화된 기능을 활용하는 것이 좋겠습니다."

[결정] → 글래스모피즘 + 적절한 배경색 대비 + 부드러운 스크롤 애니메이션 채택
```

이러한 토론을 통해 최종적으로 다음 디자인 요소들이 결정되었습니다:
- 글래스모피즘 UI (반투명 카드 디자인)
- Hero 섹션의 Zoom Out + 마스크 Reveal 효과
- 갤러리 섹션의 scroll-linked zoom 효과
- 벚꽃잎 애니메이션 효과
